...
const Philosophy = () => {
    return (
        <main className='w-4/5 h-screen mx-auto flex py-20'>
            <section className='w-full h-full'>
                <h2 className='w-1/2 mb-[5%] px-2'>How I Work</h2>
                <div className='w-full flex h-3/4'>
                    {/* Left paragraph */}
                    <motion.p
                        className='w-1/2 h-full main-p flex flex-col items-start justify-between text-paleWhite/80'
                        variants={containerVariants}
                        initial='hidden'
                        whileInView='visible'
                        viewport={{ once: true, amount: 0.3 }}
                    >
                        <motion.span className='pl-2 pr-8 border-l border-red' variants={itemVariants}>
                    ...
                    <motion.p
                        ...
                        viewport={{ once: true, amount: 0.3 }}
                    >
                        <motion.span className='pl-8 pr-2 border-l border-red' variants={itemVariants}>
